...
Agents: architect, testing, reviewer, debugger, push, idea-to-prd, pre-push, dev-ops (always) + security (when auth/payments/user data) + reliability-auditor (when event systems detected)
