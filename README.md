...
| **Workflows** | 4 | `/ultra-build`, `/ultra-review`, `/security-sweep`, `/semantic-analyze` — parallel subagent orchestration with adversarial verification (dynamic workflows; prose commands are the fallback) |
